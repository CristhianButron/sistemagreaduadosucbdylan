...
@NamedQueries({
    ...
    @NamedQuery(name = "Estudiantes.findByFechasFinBetween", query = "SELECT e FROM Estudiantes e WHERE e.fechaFin BETWEEN :fechaInicio AND :fechaFin"),
    @NamedQuery(name = "Estudiantes.findByFechasIngresoBetween", query = "SELECT e FROM Estudiantes e WHERE e.fechaIngreso BETWEEN :fechaInicio AND :fechaFin")})
